...
public:
  ...
  std::unique_ptr<MatrixInterface> newMatrix() const;
  std::unique_ptr<SmootherInterface> newSmoother(std::string type) const;
  std::unique_ptr<SmootherInterface> newCoarseSolver(std::string type) const;
  std::unique_ptr<TransferInterface> newTransfer() const;
