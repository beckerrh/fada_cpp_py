...
/*-------------------------------------------------*/
std::shared_ptr<SparseMatrix> SparseMatrix::getT() const
{
    ...
    return std::make_shared<SparseMatrix>(locations, _values, _diags.n_elem==nrows());
}
