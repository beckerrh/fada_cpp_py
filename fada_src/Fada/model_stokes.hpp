...
public:
  ...
  ModelStokes(const ParameterMap& parameters, std::shared_ptr<ApplicationInterface const> app=nullptr);
...
public:
  ...
  ModelStokes2d(const ParameterMap& parameters, std::shared_ptr<ApplicationInterface const> app) : ModelStokes(parameters, app)
  {
  }
...
public:
  ...
  ModelStokes3d(const ParameterMap& parameters, std::shared_ptr<ApplicationInterface const> app) : ModelStokes(parameters, app)
  {
  }
