...
public:
    ...
    Q1shifted(std::string varname, const ParameterMap& parameters, std::shared_ptr<ApplicationInterface const> app=nullptr);
...
public:
    ...
    Q1shifted2d(std::string varname, const ParameterMap& parameters, std::shared_ptr<ApplicationInterface const> app) : Q1shifted(varname, parameters, app)
    {
    }
...
public:
    ...
    Q1shifted3d(std::string varname, const ParameterMap& parameters, std::shared_ptr<ApplicationInterface const> app) : Q1shifted(varname, parameters, app){}
    std::string toString() const
    {
        return("Q1shifted3d");
    }
