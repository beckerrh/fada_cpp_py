...
public:
  ...
  Model<MODEL,VECTOR>(std::string varname, const ParameterMap& parameters, std::shared_ptr<ApplicationInterface const> app) : MODEL(varname, parameters, app), ModelInterface(varname) {}
